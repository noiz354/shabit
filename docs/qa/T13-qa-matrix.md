...
- (T11, 19 Sep 2026) `charts.js renderScatterIfNeeded` masih memakai `disclaimer.style.*` + `onclick` inline (Wave 2, modul chart bukan view) — utang kecil; scatter nyata NOT TESTED (ECharts di-mock di happy-dom).
